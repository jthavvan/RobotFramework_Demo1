...
Verify File Upload
    ...
    Choose File     id:file-upload  C:\\RobotFramework_Training\\RobotFramework_Demo1\\TestData\\capture1.JPG
    Click Element  id:file-submit
    Sleep  5s
    Element Text Should Be  tag:h3  File Uploaded!  timeout=5
    Element Text Should Be  id:uploaded-files  capture1.JPG  timeout=5
    Sleep  5s
    Close Browser
...
Verify File Download
    ...
    ...  download.default_directory=C:\\RobotFramework_Training\\RobotFramework_Demo1\\TestData\\Download
   ...
   #directly. Here we are passing ${prefs} which contains our Download folder path.
    ...
    Click Link  css:[href="download/capture1.JPG"]
    Sleep  5s
    ${files}  List Files In Directory  C:\\RobotFramework_Training\\RobotFramework_Demo1\\TestData\\Download
