...
Create or Refresh Token
    ...
    ${req_body}=    get file    API_TestScripts/TestData/Create_Token.json
...
Create an Address
    ...
    ${req_body}=    get file    API_TestScripts/TestData/CreateAddress.json
    log to console      ${req_body}
    ${json_body}=   convert string to json      ${req_body}
